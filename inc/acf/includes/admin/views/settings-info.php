<div class="wrap about-wrap acf-wrap">
	...
	<h2 class="nav-tab-wrapper">
		<?php foreach ( $tabs as $tab_slug => $tab_title ) : ?>
			...
			if ( $active == $tab_slug ) :
				?>
				 nav-tab-active<?php endif; ?>" href="<?php echo admin_url( "edit.php?post_type=acf-field-group&page=acf-settings-info&tab={$tab_slug}" ); ?>"><?php echo $tab_title; ?></a>
		<?php endforeach; ?>
	</h2>
	...
	<div class="feature-section">
		...
		<div class="acf-three-col">
			...
			<div>
				...
				<p><?php printf( __( 'We also wrote an <a href="%1$s">upgrade guide</a> to answer any questions, but if you do have one, please contact our support team via the <a href="%2$s">help desk</a>.', 'acf' ), esc_url( 'https://www.advancedcustomfields.com/resources/upgrade-guide-acf-pro/' ), esc_url( 'https://www.advancedcustomfields.com/support/' ) ); ?></p>
			</div>
		</div>		
	</div>
