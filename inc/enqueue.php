...
if ( ! function_exists( 'uds_wp_scripts' ) ) {
	...
	function uds_wp_scripts() {
		...
		$js_cta_version = $theme_version . '.' . filemtime( get_template_directory() . '/js/CTA-buttons.js' );
		wp_enqueue_script( 'uds-wordpress-cta-scripts', get_template_directory_uri() . '/js/CTA-buttons.js', array(), $js_cta_version, true );
