<?php
/**
 * Custom ASU Web Standards Navigation menu widget
 *
...
/* Check if function exists. */
if ( ! function_exists( 'uds_wp_theme_special_nav_class' ) ) {
	/**
...
/* Check if function exists. */
if ( ! function_exists( 'uds_wp_theme_navigation_menu_custom_walker' ) ) {
	/**
