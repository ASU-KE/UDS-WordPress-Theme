...
- **[User Guide](docs/user-guide.md)** - Complete guide for using the theme's features
...
2. Install the required plugins (see below)
...
After installing the theme and required plugins:

1. **Configure Basic Settings** - Go to **Appearance → Customize** to set up header, footer, and site identity
2. **Set Up Menus** - Create your navigation menus under **Appearance → Menus**
3. **Review Advanced Settings** - Check **Settings → UDS Advanced Settings** for additional configuration options
4. **Start Building Pages** - Use the WordPress Block Editor with included ACF blocks and patterns

For detailed information on using theme features, see the [User Guide](docs/user-guide.md).

For development setup and contributing, see the [Developer Guide](docs/developer-guide.md).
