...
`,Sf=()=>l.jsxs(l.Fragment,{children:[l.jsx(pf,{}),l.jsx(hf,{})]}),Pr=({social:e,contact:t})=>(j.useEffect(()=>{typeof window<"u"&&oa({packageName:"component-StyledFooter",component:"Component Footer",type:"NA",configuration:{social:e,contact:t}})},[]),l.jsxs(Ef,{role:"contentinfo",children:[e&&l.jsx(Or,{social:e}),t&&l.jsx(Sr,{contact:t}),l.jsx(Sf,{})]}));Pr.propTypes={social:Te.shape(Or.propTypes),contact:Te.shape(Sr.propTypes)};const Of=(e,t,n)=>{xn(n).render(j.createElement(e,t))},Pf=({targetSelector:e,props:t})=>{Of(Pr,t,document.querySelector(e))},Tf={Lg:"992px",Xl:"1260px"},qo=j.createContext(),_o=({initialValue:e,children:t})=>{const n={...e,breakpoint:Tf[e.breakpoint]};return l.jsx(qo.Provider,{value:n,children:t})};_o.propTypes={initialValue:u.shape(sa).isRequired,children:u.node.isRequired};const je=()=>{const e=j.useContext(qo);if(e===void 0)throw new Error("useAppContext must be used within a AppContextProvider");return e},hn=e=>{const t=window==null?void 0:window.matchMedia(`(max-width: ${e})`),[n,r]=j.useState(t==null?void 0:t.matches),a=o=>{r(o.matches)};return j.useEffect(()=>(t.addEventListener("change",a),()=>t.removeEventListener("change",a)),[]),n},Lf=pe.div`
