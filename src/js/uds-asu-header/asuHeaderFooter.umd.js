...
`,kr=({isPartner:e=!1,navTree:t,title:n,baseUrl:r="/",parentOrg:a,parentOrgUrl:o,partnerLogo:i,logo:s,loggedIn:d,userName:f,loginLink:g,onLoginClick:h,logoutLink:b,onLogoutClick:P,buttons:y,breakpoint:p="Xl",animateTitle:v,expandOnHover:T=!1,mobileNavTree:E,searchUrl:O,site:B,renderDiv:A="false"})=>{const Z=di(t),ie=di(E),J=j.useRef(null),ae=()=>{const q=window.scrollY;J!=null&&J.current&&(q>J.current.getBoundingClientRect().top?J.current.classList.add("scrolled"):J.current.classList.remove("scrolled"))};j.useEffect(()=>{typeof window<"u"&&oa({packageName:"component-header",component:"Component Header",type:"NA",configuration:{site:B,isPartner:e,searchUrl:O,navTree:Z,parentOrg:a,buttons:y,mobileNavTree:ie}})},[]),j.useEffect(()=>(window==null||window.addEventListener("scroll",ae),()=>window.removeEventListener("scroll",ae)),[]);const le=()=>{const q=A==="true"?eu:$f;return l.jsx(q,{id:"asuHeader",ref:J,breakpoint:p,children:l.jsx(Zf,{})})};return l.jsx(_o,{initialValue:{isPartner:e,navTree:Z,title:n,baseUrl:r,parentOrg:a,parentOrgUrl:o,partnerLogo:i,logo:s,loggedIn:d,userName:f,loginLink:g,onLoginClick:h,logoutLink:b,onLogoutClick:P,buttons:y,breakpoint:p,animateTitle:v,expandOnHover:T,mobileNavTree:ie,hasNavigation:!!(Z!=null&&Z.length)||!!(ie!=null&&ie.length),searchUrl:O,site:B},children:le()})};kr.propTypes={...sa};const tu=(e,t,n)=>{wn(n).render(j.createElement(e,t))},nu=({targetSelector:e,props:t})=>{tu(kr,t,document.querySelector(e))};Be.ASUFooter=Tr,Be.ASUHeader=kr,Be.initASUFooter=Tf,Be.initGlobalHeader=nu,Object.defineProperty(Be,Symbol.toStringTag,{value:"Module"})});
/**
 * @license React
