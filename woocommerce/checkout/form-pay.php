	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-quantity"><?php esc_html_e( 'Qty', 'asu-web-standards' ); ?></th>
				<th class="product-total"><?php esc_html_e( 'Totals', 'asu-web-standards' ); ?></th>
			</tr>
		</thead>
		<tbody>
