 ...
 * Block Registration
 *
 * Block name: UDS Full Width Container
...
acf_register_block_type(
	array(
		...
		'title'             => __( 'UDS Full Width Container', 'uds-wordpress-theme' ),
		'description'       => __( 'A wrapper to apply a background color or texture to a container.', 'uds-wordpress-theme' ),
		'icon'              => 'star-filled',
		'render_template'   => 'templates-blocks/full-width-container/full-width-container.php',
		'category'          => 'layout',
