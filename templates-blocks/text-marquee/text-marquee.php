...
<div class="uds-text-marquee-wrapper <?php echo esc_attr( $additional_classes ); ?> <?php echo esc_attr( $bg_color ); ?>" 
	...
	<button id="playMarquee" type="button" class="btn btn-circle btn-circle-alt-white btn-circle-large uds-marquee-play-btn" data-ga="play text marquee" data-ga-name="onclick" data-ga-event="button" data-ga-action="click" data-ga-type="animation play" data-ga-region="text marquee" data-ga-section="text marquee">
    ...
    <button id="pauseMarquee" type="button" class="btn btn-circle btn-circle-alt-white btn-circle-large uds-marquee-pause-btn" data-ga="pause text marquee" data-ga-name="onclick" data-ga-event="button" data-ga-action="click" data-ga-type="animation pause" data-ga-region="text marquee" data-ga-section="text marquee">
