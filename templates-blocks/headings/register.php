...
acf_register_block_type(
	array(
		...
		'title'             => __( 'UDS Headings Block', 'uds-wordpress-theme' ), // name the user will see.
		...
		'supports'          => array(
			'align' => true, // Remove the align button in the editor toolbar.
			'html' => true, // Allows the use of html editor.
		),
