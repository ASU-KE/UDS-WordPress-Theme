...
function initializeAnchorMenu () {
	...
	console.log(`globalHeaderId:`);
	console.log(globalHeaderId);
	const globalHeader = document.getElementById(globalHeaderId);
	console.log(`globalHeader:`);
	console.log(globalHeader);
	const parentElement = document.getElementById("collapseAnchorMenu");
	console.log(`parentElement:`);
	console.log(parentElement);
	const navbar = parentElement.querySelector(".nav"); // Select child with a specific class
	console.log(`navbar:`);
	console.log(navbar);
	const navbarOriginalParent = navbar.parentNode;
	console.log(`navbarOriginalParent:`);
	console.log(navbarOriginalParent);
	const navbarOriginalNextSibling = navbar.nextSibling;
	console.log(`navbarOriginalNextSibling:`);
	console.log(navbarOriginalNextSibling);
	...
	const navbarOriginalParentParent = navbarOriginalParent.parentNode;
	console.log(`navbarOriginalParentParent:`);
	console.log(navbarOriginalParentParent);
	const navbarOriginalParentParentParent = navbarOriginalParentParent.parentNode;
	console.log(`navbarOriginalParentParentParent:`);
	console.log(navbarOriginalParentParentParent);
  ...
  // Cache the anchor target elements
	for (let anchor of anchors) {
		const targetId = anchor.getAttribute('data-testid').replace('#', '');
	...
	*/
	...
	window.addEventListener("scroll", function () {
		...
		parentElement.insertBefore(navbar, null);
