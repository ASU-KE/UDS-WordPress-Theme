...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|uds-size-4"}}},"layout":{"type":"default"}} -->
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--uds-size-4)"><!-- wp:heading {"level":3,"className":"mt-0"} -->
