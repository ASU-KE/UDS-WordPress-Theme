...
<!-- wp:image {"align":"right","id":5129,"sizeSlug":"full","linkDestination":"none"} -->
<figure class="wp-block-image alignright size-full"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/patterns/images/384-square.png" alt="" class="wp-image-5129"/></figure>
<!-- /wp:image -->
