			...
			<div class="row">
				<div class="col">
					<div class="d-flex footer-innovation-links">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/img/innovation-lockup/on-gold/ASU-2022-Innovation-RGB-for-Digital-Lockup-wide-on-gold.png" alt="Number one in the U.S. for innovation. ASU ahead of MIT and Stanford . - U.S. News and World Report, 6 years, 2016-2021">
					</a>
