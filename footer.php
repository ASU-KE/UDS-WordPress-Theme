			...
			<div class="row">
				<div class="col">
					<div class="d-flex footer-innovation-links">
						...
						<img src="<?php echo get_template_directory_uri(); ?>/img/innovation-lockup/on-gold/ASU-2022-Innovation-RGB-for-Digital-Lockup-wide-on-gold@2x.png" alt="Number one in the U.S. for innovation. ASU ahead of MIT and Stanford . - U.S. News and World Report, 6 years, 2016-2021">
					</a>
			...
			<div class="row">
				<div class="col">
					<nav class="nav colophon" aria-label="University Legal and Compliance">
						...
						<a class="nav-link" href="https://eoss.asu.edu/health/announcements/coronavirus">COVID-19</a>
					</nav>
				</div>
			</div>
		</div>
